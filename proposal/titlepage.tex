\begin{titlepage}
	...
	\textsc{\Large tri-chandra campus,}\\[0.4cm] % Major heading such as course name
	\textsc{\large ghantaghar,kathmandu}\\[0.4cm] % Minor heading such as course title
	%----------------------------------------------------------------------------------------
	%	TITLE SECTION
	%----------------------------------------------------------------------------------------
	\HRule \\[0.4cm]
	{ \huge \bfseries Modeling of Magnetic Resonance\\[0.4cm] Wireless Electric Vehicle\\[0.4cm] Charging}\\[0.4cm] % Title of your document
	\HRule \\[1.5cm]
